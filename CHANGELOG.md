...
* **deps:** update docker:29.5.3-dind docker digest to ad68e89 ([6d119f9](https://gitlab.com/lx-industries/rmcp-actix-web/commit/6d119f94be8862440e926a1779693704538de065))
* **deps:** update rust crate bon to v3.9.2 ([ea26ec6](https://gitlab.com/lx-industries/rmcp-actix-web/commit/ea26ec6603620eacea5e84c09d09051df34f5a36))
* **deps:** update rust crate http to v1.4.2 ([1a6fedc](https://gitlab.com/lx-industries/rmcp-actix-web/commit/1a6fedcca594d856cac6933907b61821bb0ca74d))
* **deps:** update rust crate insta to v1.48.0 ([4990a88](https://gitlab.com/lx-industries/rmcp-actix-web/commit/4990a887e9b35a826c476bb34c243e772958f7ee))
* **deps:** update semantic-release to v25.0.5 ([b23339e](https://gitlab.com/lx-industries/rmcp-actix-web/commit/b23339e1489ecace385b0aa0c2f8463ae9eee535))
...
* **deps:** update commitlint monorepo to v21.0.2 ([d6ea3f4](https://gitlab.com/lx-industries/rmcp-actix-web/commit/d6ea3f4833d3726e8a72f9e5d530b69d6498684a))
* **deps:** update registry.gitlab.com/lx-industries/rmcp-actix-web/images/rust docker tag to v1.96.0 ([6402b38](https://gitlab.com/lx-industries/rmcp-actix-web/commit/6402b385702d8c0538126a7a31f9002187a15c0b))
* **deps:** update registry.gitlab.com/lx-industries/rmcp-actix-web/images/rust:1.95.0-x86_64-unknown-linux-gnu docker digest to 9c07b8e ([d013119](https://gitlab.com/lx-industries/rmcp-actix-web/commit/d01311936633677b2d6c757289578ca25472d3b1))
* **deps:** update rust crate http to v1.4.1 ([b3ebbbd](https://gitlab.com/lx-industries/rmcp-actix-web/commit/b3ebbbd4d20c045f8d755e775cdc92c2061ad7d2))
* **deps:** update rust crate reqwest to v0.13.4 ([ca1d533](https://gitlab.com/lx-industries/rmcp-actix-web/commit/ca1d533fefdc57e64139e501d9a4781e312154a8))
* **deps:** update rust docker tag to v1.96.0 ([3b08c3e](https://gitlab.com/lx-industries/rmcp-actix-web/commit/3b08c3ead511d0c4e533e7443aa638f74c83cdc3))
* **deps:** update rust:1.95.0 docker digest to f49565f ([c4313a8](https://gitlab.com/lx-industries/rmcp-actix-web/commit/c4313a8cb20ff318134ca256b9e1a2ff5f44167c))
...
* **deps:** update docker docker tag to v29.3.1 ([213f8d2](https://gitlab.com/lx-industries/rmcp-actix-web/commit/213f8d242ffbffd6e8825adff621b2329ddf04c7))
* **deps:** update node.js to v24.14.1 ([6bc5238](https://gitlab.com/lx-industries/rmcp-actix-web/commit/6bc52383a9669a0392506fb88bfeaa5ba9c9f253))
* **deps:** update registry.gitlab.com/lx-industries/rmcp-actix-web/images/rust docker tag to v1.94.1 ([30f2a57](https://gitlab.com/lx-industries/rmcp-actix-web/commit/30f2a57f80107a85127ddb30211e2b1ee319be8f))
* **deps:** update rust crate insta to v1.47.0 ([a147511](https://gitlab.com/lx-industries/rmcp-actix-web/commit/a14751165d8aabccd01a81c56060a326420a856a))
* **deps:** update rust crate insta to v1.47.1 ([27cbb3f](https://gitlab.com/lx-industries/rmcp-actix-web/commit/27cbb3fc32d5b427b21f61e9987f7c31bbc27bea))
* **deps:** update rust crate rmcp to v1.3.0 ([1d32550](https://gitlab.com/lx-industries/rmcp-actix-web/commit/1d325505e9b7a807d97cc4ea7eb08ec229ff642b))
* **deps:** update rust docker tag to v1.94.1 ([0b596b2](https://gitlab.com/lx-industries/rmcp-actix-web/commit/0b596b258521937a2b0359af73d136861951c1dd))
* **deps:** update rust:1.94.1 docker digest to f2a0f2b ([82b0790](https://gitlab.com/lx-industries/rmcp-actix-web/commit/82b07908942241f68e1db207af57581fb2e3108a))
